...
<html>
	...
	<body>
	        ...
	        <div class="container-fluid">
	            ...
	            <div class="collapse navbar-collapse" id="navbarNav">
	                <ul class="navbar-nav ms-auto">
	                    ...
	                    <li class="nav-item">
	                        <a class="nav-link" href="#">Mis postres</a>
	                    </li>
	                    <li class="nav-item">
	                        <a class="nav-link" href="#">Editar postre</a>
	                    </li>
	                    <li class="nav-item">
		...
		<div class="contenedor-general">
			...
			<form:form action="/actualizar/postre/${postre.id}" modelAttribute="postre" method="POST">
